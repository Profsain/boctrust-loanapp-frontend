...
const validationSchema = Yup.object({
  ...
  loanbalance: Yup.string().required("Required"),
  ...
  beneficiaryaccountnumber: Yup.number().required("Required").min(10, 'Must be exactly 10 digits').max(10, 'Must be exactly 10 digits'),
