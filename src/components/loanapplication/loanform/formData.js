const formData = (formValues) => {
    ...
    formData.append("disbursementaccountnumber", formValues.disbursementaccountnumber);
    formData.append("hasloan", formValues.hasloan);
    formData.append("currentmonthlyplanrepaymentamount", formValues.currentmonthlyplanrepaymentamount);
    formData.append("estimatedmonthlylivingexpense", formValues.estimatedmonthlylivingexpense);
    ...
    formData.append("beneficiaryaccountnumber", formValues.beneficiaryaccountnumber);
