        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mx-auto">
              ...
              <Nav.Link href="/product"className="mx-4">Our Product</Nav.Link>
              <Nav.Link href="/loan"className="mx-4">Apply for Loan</Nav.Link>
              <Nav.Link href="/support"className="mx-4">Support</Nav.Link>
